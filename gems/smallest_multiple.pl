...
#ref: https://perlweeklychallenge.org/blog/advent-calendar-2020-12-12/
#     The part using Benford's Law needs more rigorous implementation.
#
# todo of the code: improve its performance on 9's multiples
